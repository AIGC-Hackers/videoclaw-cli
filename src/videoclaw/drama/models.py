...
class SceneFunction(StrEnum):
    """Mandatory scene function — every scene must serve exactly one."""

    ESCALATE = "escalate"           # (A) Escalate the conflict
    REVEAL = "reveal"               # (B) Reveal new information or betrayal
    EMOTIONAL_PEAK = "emotional_peak"  # (C) Trigger emotional peak
...
class DramaScene:
    ...
    # Pre-production metadata (added for pre-production manual compliance)
    act_number: str = ""        # act_1 / act_2 / act_3 / act_4
    is_reversal: bool = False
    reversal_description: str = ""  # 1-sentence description of the reversal
    scene_function: str = ""    # escalate / reveal / emotional_peak
    # Enhanced prompt (generated by PromptEnhancer, persisted for reproducibility)
    enhanced_visual_prompt: str = ""
